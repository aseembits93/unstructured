...
def get_default_pandas_dtypes() -> dict[str, Any]:
    # Use variables instead of repeated calls and literals for shared objects/types
    s = _pd_string_dtype
    i = _int64_dtype
    b = _boolean_dtype
    f = _float_type
    ...
    return {
        ...
        "subject": s,
        "section": s,
        "header_footer_type": s,
        "emphasized_text_contents": o,
        "emphasized_text_tags": o,
        "text_as_html": s,
        "max_characters": i,
        "is_continuation": b,
        "detection_class_prob": f,
        "sender": s,
        "coordinates_points": o,
        "coordinates_system": s,
        "coordinates_layout_width": f,
        "coordinates_layout_height": f,
        "data_source_url": s,
        "data_source_version": s,
        "data_source_record_locator": o,
        "data_source_date_created": s,
        "data_source_date_modified": s,
        "data_source_date_processed": s,
        "data_source_permissions_data": o,
        "embeddings": o,
    }
...
_pd_string_dtype = pd.StringDtype()
